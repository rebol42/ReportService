...
namespace ReportService.Core
{
    ...
    {
        public string GenerateErros(List<Error> errors, int interval)
        {
            if (errors == null)
            ...
            html += @"</table><br /><br /><i>Automatyczna wiadomosc z aplikacji ReportService</i>";
        ...
        public string GenerateReport(Report report)
        {
            ...
            html += @"<br /><br /><i>Automatyczna wiadomosc z aplikacji ReportService</i>";
